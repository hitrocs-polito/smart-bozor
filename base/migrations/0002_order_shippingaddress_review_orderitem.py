    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taxPrice', models.DecimalField(decimal_places=2, max_digits=15, null=True)),
                ('shippingPrice', models.DecimalField(decimal_places=2, max_digits=15, null=True)),
                ('totalPrice', models.DecimalField(decimal_places=2, max_digits=15, null=True)),
